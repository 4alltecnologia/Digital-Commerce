---
title: Digital Commerce - Android - 1.3
...
```Java
FourAll_DigitalCommerce digiCommerce;
digiCommerce = FourAll_DigitalCommerce.newInstance(MainActivity.this)
```
...
digiCommerce =  FourAll_DigitalCommerce.newInstance(
                  MainActivity.this,
                  <<APIKEY do cliente>>
                );
```
...
digiCommerce =  FourAll_DigitalCommerce.newInstance(
                  MainActivity.this, DigitalCommerce_Config.getDefaultConfig()
                );
```
...
pay4allObject = FourAll_DigitalCommerce.newInstance(MainActivity.this);
...
int permissionCheckCoarse = ContextCompat.checkSelfPermission(
                              thisActivity, Manifest.ACCESS_COARSE_LOCATION
                            );

int permissionCheckFine = ContextCompat.checkSelfPermission(
                            thisActivity, Manifest.ACCESS_FINE_LOCATION
                          );
```
...
```Java
FourAll_DigitalCommerce pay4allObject = FourAll_DigitalCommerce.newInstance(MainActivity.this);
